...
public class Trans extends javax.swing.JFrame {
    ...
    public Trans() {
        ...
        setTitle("FAIRPRICE TRANSACTION");
        setIconImage(icon);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Transaction Id", "Permanent Customer Id", "Purchase point", "Total Bill"
            }
        ) {
        ...
        jScrollPane1.setBounds(0, 85, 1580, 730);
        ...
        jLabel2.setBounds(280, 0, 1300, 80);
        ...
        jButton1.setBounds(20, 30, 72, 31);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         CusDashboard a=new CusDashboard();
        a.setVisible(true);
        dispose();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            ...
            while(rs.next())
            {
               String aaa[]={Integer.toString(rs.getInt(6)),rs.getString(3),Integer.toString(rs.getInt(4)),Integer.toString(rs.getInt(2))};
               m.insertRow(i,aaa);
               i++;
            }   
